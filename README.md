...
# <img src="img/cdp120.png" alt="Logo 320" title="Logo CDP" width="50"> CHANNEL DISCOVERY PROTOCOL (CDP / SOP v2.3)
...
L'harness opera categoricamente come **MODULO AUTONOMO (Standalone Metrology Suite)**, totalmente isolato dal System Under Test (SUT) e dai relativi adapter di invocazione locale (es. **[Bash4LLM](https://github.com/kamaludu/bash4llm)** ).
